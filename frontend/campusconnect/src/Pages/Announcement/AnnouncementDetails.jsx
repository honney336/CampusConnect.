...
const AnnouncementDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 pt-16 px-4 sm:px-6 lg:px-8 pb-12">
      <div className="max-w-4xl mx-auto">
        {/* Back Button */}
        <button
          onClick={() => navigate('/announcements')}
          className="group mb-6 flex items-center text-blue-600 hover:text-blue-700 transition-colors duration-200"
        >
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden border border-blue-100">
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                {announcement.priority && (
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm ${PRIORITY_COLORS[announcement.priority]}`}>
          ...
          <div className="bg-blue-50/50 border-t border-blue-100">
            <div className="px-6 py-4">
              {announcement.course && (
                <div className="mb-4">
                  <div className="inline-flex items-center px-4 py-2 bg-white rounded-lg border border-blue-100 
                               shadow-sm">
              ...
              <div className="flex justify-between items-center text-sm">
                ...
                <div className="flex items-center text-gray-600 bg-white px-3 py-1.5 rounded-lg">
                  ...
                  <time>{new Date(announcement.created_At).toLocaleDateString()}</time>
                </div>
              </div>
            </div>
          </div>
